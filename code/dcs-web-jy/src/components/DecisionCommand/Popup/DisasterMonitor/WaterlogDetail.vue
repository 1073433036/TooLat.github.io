<template>
  <main id="WaterlogDetail" class="decision-popup" v-drag>
    <header>
      <span>内涝点（{{ info.name }}）</span>
...
<script lang='ts'>
  ...
  @Component
  export default class WaterlogDetail extends Vue {
    ...
    closePopup() {
      this.storePopupStatus_global({ key: 'waterlogDetail', action: false })
