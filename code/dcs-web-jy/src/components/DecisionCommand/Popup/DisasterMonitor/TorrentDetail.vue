<template>
  <main id="TorrentDetail" class="decision-popup" v-drag>
    <header>
      <span>山洪信息点</span>
...
<script lang='ts'>
  ...
  @Component
  export default class TorrentDetail extends Vue {
    ...
    closePopup() {
      this.storePopupStatus_global({ key: 'torrentDetail', action: false })
