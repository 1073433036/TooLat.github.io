...
<script lang='ts'>
  ...
  @Component
  export default class WarningRealTime extends Vue {
    ...
    elements: any[] = [
      ...
      { key: 'wd2df', name: '风力风向', unit: 'm/s', selected: false },
      { key: 'wd10maxdf', name: '最大风', unit: 'm/s', selected: false },
      { key: 'wd3smaxdf', name: '极大风', unit: 'm/s', selected: false },
    ]
    ...
    // 初始化时 默认选中元素
    initialization() {
      this.elements.find(el => el.key === 'wd2df').selected = true
...
#WarningRealTime{
  ...
  ul.elements li em {
    ...
    &.wd3smaxdf { background: rgb(33, 33, 251); }
  }
}
</style>