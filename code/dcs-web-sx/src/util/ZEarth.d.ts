declare module Zearth {
    ...
    class GeometryInstance {
        ...
        id: any;
        attributes: any;
        constructor(options: { geometry: Geometry | EllipseGeometry; modelMatrix?: Matrix4; id?: any; attributes?: any });
    }
    ...
    class PointPrimitiveCollection {
        ...
        length: number;
        constructor(options?: { modelMatrix?: Matrix4; debugShowBoundingVolume?: boolean });
        add(pointPrimitive?: PointGeometryInterface): PointPrimitive;
    ...
    class ZearthInspector {
        container: Element;
        viewModel: ZearthInspectorViewModel;
        constructor(container: Element | string, scene: Scene);
        isDestroyed(): boolean;
        destroy();
    }

    class ZearthInspectorViewModel {
        frustums: boolean;
        performance: boolean;
    ...
    function viewerZearthInspectorMixin(viewer: Viewer);
    ...
    interface PointGeometryInterface {
        show?: boolean;
        position?: Cartesian3;
        scaleByDistance?: NearFarScalar;
        translucencyByDistance?: NearFarScalar;
