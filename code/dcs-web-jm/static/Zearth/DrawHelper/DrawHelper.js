...
var DrawHelper = (function() {
    ...
    // static variables
    var ellipsoid = Zearth.Ellipsoid.WGS84;

    // constructor
    function _(zearthWidget) {
        this._scene = zearthWidget.scene;
        this._tooltip = createTooltip(zearthWidget.container);
        this._surfaces = [];
    ...
    _.prototype.initialiseHandlers = function() {
        ...
        var _self = this;
        // scene events
        var handler = new Zearth.ScreenSpaceEventHandler(scene.canvas);
        ...
        handler.setInputAction(
            ...
            }, Zearth.ScreenSpaceEventType.LEFT_DOUBLE_CLICK);
        var mouseOutObject;
        handler.setInputAction(
            function (movement) {
                if(_self._handlersMuted == true) return;
        ...
        handler.setInputAction(
            ...
            }, Zearth.ScreenSpaceEventType.LEFT_UP);
        handler.setInputAction(
            function (movement) {
                callPrimitiveCallback('leftDown', movement.position);
            }, Zearth.ScreenSpaceEventType.LEFT_DOWN);
    }
    ...
    _.prototype.registerEditableShape = function(surface) {
        ...
        setListener(surface, 'mouseMove', function(position) {
            ...
            if(!surface._editMode) {
                _self._tooltip.showAt(position, "点击鼠标左键可编辑图形");
            }
        });
    ...
    var material = Zearth.Material.fromType(Zearth.Material.ColorType);
    material.uniforms.color = new Zearth.Color(1.0, 1.0, 0.0, 0.5);

    var defaultShapeOptions = {
        ellipsoid: Zearth.Ellipsoid.WGS84,
    ...
    var defaultSurfaceOptions = copyOptions(defaultShapeOptions, {
        appearance: new Zearth.EllipsoidSurfaceAppearance({
            aboveGround : false
        }),
    	material : material,
    ...
    var defaultPolylineOptions = copyOptions(defaultShapeOptions, {
        ...
        geodesic: true,
        granularity: 10000,
        appearance: new Zearth.PolylineMaterialAppearance({
            aboveGround : false
        }),
    	material : material
    });

//    Zearth.Polygon.prototype.setStrokeStyle = setStrokeStyle;
//
//    Zearth.Polygon.prototype.drawOutline = drawOutline;
//
    ...
    var ChangeablePrimitive = (function() {
        ...
        _.prototype.update = function(context, frameState, commandList) {
            ...
            if (!Zearth.defined(this.ellipsoid)) {
                throw new Zearth.DeveloperError('this.ellipsoid must be defined.');
            }

            if (!Zearth.defined(this.appearance)) {
                throw new Zearth.DeveloperError('this.material must be defined.');
            }

            if (this.granularity < 0.0) {
                throw new Zearth.DeveloperError('this.granularity and scene2D/scene3D overrides must be greater than zero.');
            }
            ...
            if (!this._createPrimitive && (!Zearth.defined(this._primitive))) {
            ...
            if (this._createPrimitive ||
                ...
                this._primitive = new Zearth.Primitive({
                ...
                if(this.strokeColor && this.getOutlineGeometry) {
                    ...
                    this._outlinePolygon = new Zearth.Primitive({
                        geometryInstances : new Zearth.GeometryInstance({
                            geometry : this.getOutlineGeometry(),
                            attributes : {
                                color : Zearth.ColorGeometryInstanceAttribute.fromColor(this.strokeColor)
                            }
                        }),
        ...
        _.prototype.destroy = function() {
            this._primitive = this._primitive && this._primitive.destroy();
            return Zearth.destroyObject(this);
        };
    ...
    _.ExtentPrimitive = (function() {
        function _(options) {
            ...
            if(!Zearth.defined(options.extent)) {
                throw new Zearth.DeveloperError('Extent is required');
            }
        ...
        _.prototype.getGeometry = function() {
            ...
            if (!Zearth.defined(this.extent)) {
                return;
            }

            return new Zearth.RectangleGeometry({
        ...
        _.prototype.getOutlineGeometry = function() {
            return new Zearth.RectangleOutlineGeometry({
                rectangle: this.extent
            });
        }
    ...
    _.PolygonPrimitive = (function() {
        ...
        _.prototype.getGeometry = function() {
            ...
            if (!Zearth.defined(this.positions) || this.positions.length < 3) {
                return;
            }

            return Zearth.PolygonGeometry.fromPositions({
        ...
        _.prototype.getOutlineGeometry = function() {
            return Zearth.PolygonOutlineGeometry.fromPositions({
    ...
    _.CirclePrimitive = (function() {
        ...
        function _(options) {
            ...
            if(!(Zearth.defined(options.center) && Zearth.defined(options.radius))) {
                throw new Zearth.DeveloperError('Center and radius are required');
            }
        ...
        _.prototype.getGeometry = function() {
            ...
            if (!(Zearth.defined(this.center) && Zearth.defined(this.radius))) {
                return;
            }

            return new Zearth.CircleGeometry({
                center : this.center,
                radius : this.radius,
                height : this.height,
                vertexFormat : Zearth.EllipsoidSurfaceAppearance.VERTEX_FORMAT,
        ...
        _.prototype.getOutlineGeometry = function() {
            return new Zearth.CircleOutlineGeometry({
    ...
    _.EllipsePrimitive = (function() {
        function _(options) {
            ...
            if(!(Zearth.defined(options.center) && Zearth.defined(options.semiMajorAxis) && Zearth.defined(options.semiMinorAxis))) {
                throw new Zearth.DeveloperError('Center and semi major and semi minor axis are required');
            }
        ...
        _.prototype.getGeometry = function() {
            ...
            if(!(Zearth.defined(this.center) && Zearth.defined(this.semiMajorAxis) && Zearth.defined(this.semiMinorAxis))) {
                return;
            }

            return new Zearth.EllipseGeometry({
                        ellipsoid : this.ellipsoid,
                        center : this.center,
        ...
        _.prototype.getOutlineGeometry = function() {
            return new Zearth.EllipseOutlineGeometry({
                center: this.getCenter(),
    ...
    _.PolylinePrimitive = (function() {
        ...
        _.prototype.getGeometry = function() {
            ...
            if (!Zearth.defined(this.positions) || this.positions.length < 2) {
                return;
            }

            return new Zearth.PolylineGeometry({
                    positions: this.positions,
                    height : this.height,
    ...
    var defaultBillboard = {
        iconUrl: "./static/Zearth/DrawHelper/img/dragIcon.png",
        shiftX: 0,
        shiftY: 0
    }
    ...
    var dragHalfBillboard = {
        iconUrl: "./static/Zearth/DrawHelper/img/dragIconLight.png",
        shiftX: 0,
        shiftY: 0
    }
    ...
    _.BillboardGroup = function(drawHelper, options) {
        ...
        var b = new Zearth.BillboardCollection();
    ...
    _.BillboardGroup.prototype.createBillboard = function(position, callbacks) {
        ...
        var billboard = this._billboards.add({
            show : true,
            position : position,
            pixelOffset : new Zearth.Cartesian2(this._options.shiftX, this._options.shiftY),
            eyeOffset : new Zearth.Cartesian3(0.0, 0.0, 0.0),
            horizontalOrigin : Zearth.HorizontalOrigin.CENTER,
            verticalOrigin : Zearth.VerticalOrigin.CENTER,
            scale : 1.0,
            image: this._options.iconUrl,
            color : new Zearth.Color(1.0, 1.0, 1.0, 1.0)
        });
        ...
        if(callbacks) {
            ...
            if(callbacks.dragHandlers) {
                ...
                setListener(billboard, 'leftDown', function(position) {
                    ...
                    var handler = new Zearth.ScreenSpaceEventHandler(_self._scene.canvas);
    ...
    _.BillboardGroup.prototype.getBillboardCollection = function() {
    ...
    _.prototype.startDrawingMarker = function(options) {
        ...
        var mouseHandler = new Zearth.ScreenSpaceEventHandler(scene.canvas);
    ...
    _.prototype.startDrawingPolyshape = function(isPolygon, options) {
        ...
        mouseHandler.setInputAction(function(movement) {
            ...
            if(position != null) {
                if(positions.length == 0) {
                    tooltip.showAt(position, "<p>鼠标左键点击添加第一个点</p>");
                } else {
                    var cartesian = scene.camera.pickEllipsoid(position, ellipsoid);
                    if (cartesian) {
                        positions.pop();
                        ...
                        // show tooltip
                        tooltip.showAt(position, "<p>鼠标左键点击添加点 (" + positions.length + ")</p>" + (positions.length > minPoints ? "<p>双击鼠标左键完成绘制</p>" : ""));
                    }
                }
            }
        }, Zearth.ScreenSpaceEventType.MOUSE_MOVE);
    ...
    function getExtentCorners(value) {
        return ellipsoid.cartographicArrayToCartesianArray([Zearth.Rectangle.northwest(value), Zearth.Rectangle.northeast(value), Zearth.Rectangle.southeast(value), Zearth.Rectangle.southwest(value)]);
    }
    ...
    _.prototype.startDrawingExtent = function(options) {
        ...
        function updateExtent(value) {
            if(extent == null) {
                extent = new Zearth.PrimitiveCollection();
        ...
        mouseHandler.setInputAction(function(movement) {
            ...
            if(position != null) {
                if(extent == null) {
                    tooltip.showAt(position, "<p>点击鼠标左键开始绘制矩形</p>");
                } else {
                    var cartesian = scene.camera.pickEllipsoid(position, ellipsoid);
                    if (cartesian) {
                        var value = getExtent(firstPoint, ellipsoid.cartesianToCartographic(cartesian));
                        updateExtent(value);
                        tooltip.showAt(position, "<p>按住鼠标左键拖动确定矩形大小</p><p>点击鼠标左键完成绘制</p>");
                    }
                }
            }
        }, Zearth.ScreenSpaceEventType.MOUSE_MOVE);
    ...
    _.prototype.startDrawingCircle = function(options) {
        ...
        mouseHandler.setInputAction(function(movement) {
            ...
            if(position != null) {
                if(circle == null) {
                    tooltip.showAt(position, "<p>鼠标左键点击开始绘制圆</p>");
                } else {
                    var cartesian = scene.camera.pickEllipsoid(position, ellipsoid);
                    if (cartesian) {
                        circle.setRadius(Zearth.Cartesian3.distance(circle.getCenter(), cartesian));
                        markers.updateBillboardsPositions(cartesian);
                        tooltip.showAt(position, "<p>移动鼠标确定圆的半径</p><p>点击鼠标左键完成绘制</p>");
                    }
                }
            }
        }, Zearth.ScreenSpaceEventType.MOUSE_MOVE);
    ...
    _.prototype.enhancePrimitives = function() {
        ...
        Zearth.Billboard.prototype.setEditable = function() {
            ...
            setListener(billboard, 'leftDown', function(position) {
                ...
                var handler = new Zearth.ScreenSpaceEventHandler(drawHelper._scene.canvas);
        ...
        function setHighlighted(highlighted) {
            ...
            if(highlighted) {
                ...
                this.setStrokeStyle(Zearth.Color.fromCssColorString('white'), this.strokeWidth);
            } else {
                    ...
                    if(this._markers == null) {
                        ...
                        function calculateHalfMarkerPosition(index) {
                            ...
                            return ellipsoid.cartographicToCartesian(
                                new Zearth.EllipsoidGeodesic(ellipsoid.cartesianToCartographic(positions[index]),
                        ...
                        this._globeClickhandler = new Zearth.ScreenSpaceEventHandler(scene.canvas);
        ...
        DrawHelper.PolylinePrimitive.prototype.setEditable = function() {
            ...
            polyline.getExtent = function() {
                return Zearth.Extent.fromCartographicArray(ellipsoid.cartesianArrayToCartographicArray(this.positions));
            }
                ...
                if(editMode) {
                    ...
                    if(this._markers == null) {
                        ...
                        function getMarkerPositions() {
                            return Zearth.Shapes.computeEllipseBoundary(ellipsoid, ellipse.getCenter(), ellipse.getSemiMajorAxis(), ellipse.getSemiMinorAxis(), ellipse.getRotation() + Math.PI / 2, Math.PI / 2.0).splice(0, 4);
                        }
                        function onEdited() {
                        ...
                        var handleMarkerChanges = {
                            dragHandlers: {
                                onDrag: function(index, position) {
                                    var distance = Zearth.Cartesian3.distance(ellipse.getCenter(), position);
                                    if(index%2 == 0) {
        ...
        _.CirclePrimitive.prototype.getCircleCartesianCoordinates = function (granularity) {
            var geometry = Zearth.CircleOutlineGeometry.createGeometry(new Zearth.CircleOutlineGeometry({ellipsoid: ellipsoid, center: this.getCenter(), radius: this.getRadius(), granularity: granularity}));
            ...
            for(; count < geometry.attributes.position.values.length; count+=3) {
                ...
                values.push(new Zearth.Cartesian3(value[count], value[count + 1], value[count + 2]));
            }
            return values;
        };
            ...
            circle.setEditMode = function(editMode) {
                ...
                if(editMode) {
                    ...
                    if(this._markers == null) {
                        var markers = new _.BillboardGroup(drawHelper, dragBillboard);
                        function getMarkerPositions() {
                            return _self.getCircleCartesianCoordinates(Zearth.Math.PI_OVER_TWO);
                        }
                        function onEdited() {
                        ...
                        var handleMarkerChanges = {
                            dragHandlers: {
                                onDrag: function(index, position) {
                                    circle.setRadius(Zearth.Cartesian3.distance(circle.getCenter(), position));
                                    markers.updateBillboardsPositions(getMarkerPositions());
                                },
                                onDragEnd: function(index, position) {
                                    onEdited();
    ...
    _.DrawHelperWidget = (function() {
        ...
        function _(drawHelper, options) {
            ...
            if(!(Zearth.defined(options.container))) {
                throw new Zearth.DeveloperError('Container is required');
            }
    ...
    function getExtent(mn, mx) {
        ...
        var epsilon = Zearth.Math.EPSILON7;
