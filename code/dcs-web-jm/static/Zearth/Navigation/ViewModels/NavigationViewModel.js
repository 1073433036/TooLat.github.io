...
define([
    'Zearth/Core/defined',
    'Zearth/Core/Math',
    'Zearth/Core/getTimestamp',
    'Zearth/Core/EventHelper',
    'Zearth/Core/Transforms',
    'Zearth/Scene/SceneMode',
    'Zearth/Core/Cartesian2',
    'Zearth/Core/Cartesian3',
    'Zearth/Core/Matrix4',
    'Zearth/Core/BoundingSphere',
    'Zearth/Core/HeadingPitchRange',
    'KnockoutES5',
    'Core/loadView',
    ...
    NavigationViewModel.prototype.destroy = function() {
        ...
        //loadView(require('fs').readFileSync(baseURLEmpZearth + 'js-lib/terrajs/lib/Views/Navigation.html', 'utf8'), container, this);
    ...
    NavigationViewModel.prototype.show = function(container) {
        ...
        if (this.enableZoomControls && this.enableCompass) {
            testing = '<div class="compass" title="Drag outer ring: rotate view. ' +
                ...
                ' <div class="compass-rotation-marker" data-bind="visible: isOrbiting, style: { transform: \'rotate(-\' + orbitCursorAngle + \'rad)\', \'-webkit-transform\': \'rotate(-\' + orbitCursorAngle + \'rad)\', opacity: orbitCursorOpacity }, zearthSvgPath: { path: svgCompassRotationMarker, width: 145, height: 145 }"></div>' +
                ' <div class="compass-outer-ring" title="Click and drag to rotate the camera" data-bind="style: { transform: \'rotate(-\' + heading + \'rad)\', \'-webkit-transform\': \'rotate(-\' + heading + \'rad)\' }, zearthSvgPath: { path: svgCompassOuterRing, width: 145, height: 145 }"></div>' +
                ' <div class="compass-gyro-background"></div>' +
                ' <div class="compass-gyro" data-bind="zearthSvgPath: { path: svgCompassGyro, width: 145, height: 145 }, css: { \'compass-gyro-active\': isOrbiting }"></div>' +
                '</div>' +
                ...
                '  <div data-bind="zearthSvgPath: { path: $data.svgIcon, width: $data.svgWidth, height: $data.svgHeight }, css: $data.isActive ?  \'navigation-control-icon-active \' + $data.cssClass : $data.cssClass"></div>' +
                '  <!-- /ko -->' +
                ' </div>' +
                ' <!-- /ko -->' +
                '</div>';
    ...
    NavigationViewModel.prototype.handleDoubleClick = function(viewModel, e) {
        ...
        camera.flyToBoundingSphere(focusBoundingSphere, {
            offset: new HeadingPitchRange(0,
                ...
                ZearthMath.PI_OVER_TWO - Cartesian3.angleBetween(
                    surfaceNormal,
                    camera.directionWC
                ),
    ...
    function orbit(viewModel, compassElement, cursorVector) {
        ...
        viewModel.orbitTickFunction = function(e) {
            ...
            var angle = viewModel.orbitCursorAngle + ZearthMath.PI_OVER_TWO;
            ...
            // viewModel.terria.zearth.notifyRepaintRequired();
        ...
        function updateAngleAndOpacity(vector, compassWidth) {
            ...
            viewModel.orbitCursorAngle = ZearthMath.zeroToTwoPi(angle - ZearthMath.PI_OVER_TWO);
    ...
    function rotate(viewModel, compassElement, cursorVector) {
        ...
        if (viewModel.terria.options.enableCompassOuterRing) {
            ...
            viewModel.rotateMouseMoveFunction = function(e) {
                ...
                var newCameraAngle = ZearthMath.zeroToTwoPi(viewModel.rotateInitialCameraAngle - angleDifference);
