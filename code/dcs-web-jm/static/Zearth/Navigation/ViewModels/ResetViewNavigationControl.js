...
define([
    'Zearth/Core/defined',
    'Zearth/Scene/Camera',
    'Zearth/Core/Rectangle',
    'Zearth/Core/Cartographic',
            ...
            if (this.terria.options.defaultResetView) {
                if (this.terria.options.defaultResetView && this.terria.options.defaultResetView instanceof Cartographic) {
                    ...
                    try {
                        ...
                        console.log("Zearth-navigation/ResetViewNavigationControl:   options.defaultResetView Zearth rectangle is  invalid!");
                    }
                }
            }
